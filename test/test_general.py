...
# TODO Auswahlmöglichkeiten zwischen den verschiedenen Problemen -> Graphen sollen darauf eingestimmt sein



# TODO visualization of 1 body problem, 2 body problem, figure of eight and 3bodyproblem

# INFO Keine direkte funktion für das entstehen von einem anderen himmelskörper, soll durch die modi im menü gehandelt werden


# TODO BARYZENTRUM hinzufügen (zu graph mit schwerkraft) + bei der visualisierung keine schwerkraftszeiger angeben
